        ...
        <div class="flex w-full max-w-4xl max-h-screen bg-white shadow-lg rounded-lg overflow-hidden">
            ...
            <div class="flex flex-col px-5 w-1/2">
                ...
                <form action="" method="get" class="p-10 flex flex-col gap-2 space-y-2">
                    ...
                    <input type="text" class="border border-gray-300 py-2 px-4 w-full rounded-sm focus:outline-none focus:border-[#EAE0CF] focus:ring-2 focus:ring-[#efe9df]" placeholder="Insert New Username...">
                    <p class="text-md font-semibold">Create New Password</p>
                    <input id="password" type="password" class="border border-gray-300 py-2 px-4 w-full rounded-sm focus:outline-none focus:border-[#EAE0CF] focus:ring-2 focus:ring-[#efe9df]" placeholder="Insert New Password...">
                    <p class="text-md font-semibold">Confirm New Password</p>
                    <input id="password" type="password" class="border border-gray-300 py-2 px-4 w-full rounded-sm focus:outline-none focus:border-[#EAE0CF] focus:ring-2 focus:ring-[#efe9df]" placeholder="Confirm New Password...">
