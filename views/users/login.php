...
<head>
    ...
    <title>Welcome to Dikerjain</title>
    ...
    <div class="min-h-screen flex items-center justify-center bg-[#94B4C1]">
        <div class="flex w-full max-w-3xl max-h-screen bg-white shadow-lg rounded-lg overflow-hidden">
            ...
            <div class="flex flex-col px-5 w-1/2">
                ...
                <?php endif; ?>
                <form action="../index.php?page=user&action=login" method="POST" class="p-10 flex flex-col gap-2 space-y-2">
                    <p class="text-md font-semibold">Username atau Email</p>
                    <input type="text" name="login" class="border border-gray-300 py-2 px-4 w-full rounded-sm focus:outline-none focus:border-blue-400 focus:ring-2 focus:ring-blue-100" placeholder="Masukkan Username atau Email...">
                    ...
                    Don't have an account? <a href="index.php?page=user&action=registerForm" class="text-blue-600 font-semibold hover:underline">Sign up</a>
                    </div>
                </form>
